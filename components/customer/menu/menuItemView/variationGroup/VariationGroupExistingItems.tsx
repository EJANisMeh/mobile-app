...
> = ({ group, selection, setVariationSelections }) => {
	...
	console.log(`📦 [VariationGroupExistingItems] Group ${group.id} (${group.name}):`)
	...
	const handleItemToggle = (menuItem: any) => {
		console.log(`🎯 [VariationGroupExistingItems] Item toggled: ${menuItem.id} (${menuItem.name})`)
		...
		<View style={styles.variationGroup}>
			...
			<View style={styles.optionsList}>
				{existingMenuItems.map((menuItem: any) => {
					...
					if (isSelected) {
						console.log(`🎨 [VariationGroupExistingItems] Rendering selected item ${menuItem.id} (${menuItem.name}):`)
